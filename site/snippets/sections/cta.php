                        ...
                        <tr>
                          <td >
                            <table border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="center"><a target="_blank" href="<?= $data->url() ?>" target="_blank" style=""><?= $data->text() ?></a></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                      </table>
                      <a href="<?= $data->urlSecondary() ?>" target="_blank"><small><?= $data->textSecondary() ?></small></a>
