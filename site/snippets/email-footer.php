              ...
              <table class="twelve columns">
                <tr>
                  <td class="text-pad center">
                    ...
                    <p>Contact Us: <a href="mailto:sales@bluebeam.com" >Sales</a> | <a href="mailto:support@bluebeam.com" >Support</a> | <a href="http://www.bluebeam.com/au/contact/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" >Help</a></p>
                    ...
                    © Copyright 2002 - 2016  <a href="http://www.bluebeam.com/au/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank" >Bluebeam, Inc</a>.  All Rights Reserved.</p>
                    <a href="http://www.bluebeam.com/au/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" ><img src="https://downloads.bluebeam.com/images/2016/universal-assets/bluebeam-b-logo-email-footer.png" alt="Bluebeam Software" ></a>

                    <?php elseif($page->language() == 'de'): ?>
                    <p>Kontakt: <a href="mailto:sales@bluebeam.com" >Vertrieb</a> | <a href="mailto:support@bluebeam.com" >Support</a> | <a href="http://www.bluebeam.com/de/contact/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" >Hilfe</a></p>
                    ...
                    <p><a href="%%ftaf_url%%" >Videresend til en ven</a> | <a href="%%subscription_center_url%%" alias="Manage Subscriptions" >Administrer abonnementer</a> | <a href="%%profile_center_url%%" alias="Update Profile" >Afmeld</a> © Copyright 2002-2016  <a href="http://www.bluebeam.com/dk/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank" >Bluebeam, Inc</a>. Alle rettigheder forbeholdes.</p><a href="http://www.bluebeam.com/dk/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" ><img src="https://downloads.bluebeam.com/images/2016/universal-assets/bluebeam-b-logo-email-footer.png" alt="Bluebeam Software" ></a>

                    <?php elseif($page->language() == 'es'): ?>
                    <p>Contact Us: <a href="mailto:sales@bluebeam.com" >Sales</a> | <a href="mailto:support@bluebeam.com" >Support</a> | <a href="http://www.bluebeam.com/es/contact/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" >Help</a></p>
                    <p>This email is sent by: %%Member_Busname%% %%Member_Addr%%,<br>%%Member_City%%, %%Member_State%% %%Member_PostalCode%%, USA
                    We respect your right to privacy - <a href="http://bluebeam.com/us/company/privacy-policy.asp" >view our policy</a></p>
                    <p><a href="%%ftaf_url%%" >Forward to a Friend</a> | <a href="%%subscription_center_url%%" alias="Manage Subscriptions" >Manage Subscriptions</a> | <a href="%%profile_center_url%%" alias="Update Profile" >Unsubscribe</a>
                    © Copyright 2002 - 2016  <a href="http://www.bluebeam.com/es/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank" >Bluebeam, Inc</a>.  All Rights Reserved.</p>
                    <a href="http://www.bluebeam.com/es/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" ><img src="https://downloads.bluebeam.com/images/2016/universal-assets/bluebeam-b-logo-email-footer.png" alt="Bluebeam Software" ></a>

                    <?php elseif($page->language() == 'fi'): ?>
                    <p>Contact Us: <a href="mailto:sales.fi@bluebeam.com" >Sales</a> | <a href="mailto:support.fi@bluebeam.com" >Support</a> | <a href="http://www.bluebeam.com/fi/contact/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" >Help</a></p>
                    <p>This email is sent by: %%Member_Busname%% %%Member_Addr%%,<br>%%Member_City%%, %%Member_State%% %%Member_PostalCode%%, USA
                    We respect your right to privacy - <a href="http://bluebeam.com/us/company/privacy-policy.asp" >view our policy</a></p>
                    <p><a href="%%ftaf_url%%" >Forward to a Friend</a> | <a href="%%subscription_center_url%%" alias="Manage Subscriptions" >Manage Subscriptions</a> | <a href="%%profile_center_url%%" alias="Update Profile" >Unsubscribe</a>
                    © Copyright 2002 - 2016  <a href="http://www.bluebeam.com/fi/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank" >Bluebeam, Inc</a>.  All Rights Reserved.</p>
                    <a href="http://www.bluebeam.com/fi/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" ><img src="https://downloads.bluebeam.com/images/2016/universal-assets/bluebeam-b-logo-email-footer.png" alt="Bluebeam Software" ></a>

                    <?php elseif($page->language() == 'fr'): ?>
                    <p>Contact Us: <a href="mailto:sales@bluebeam.com" >Sales</a> | <a href="mailto:support@bluebeam.com" >Support</a> | <a href="http://www.bluebeam.com/fr/contact/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" >Help</a></p>
                    <p>This email is sent by: %%Member_Busname%% %%Member_Addr%%,<br>%%Member_City%%, %%Member_State%% %%Member_PostalCode%%, USA
                    We respect your right to privacy - <a href="http://bluebeam.com/us/company/privacy-policy.asp" >view our policy</a></p>
                    <p><a href="%%ftaf_url%%" >Forward to a Friend</a> | <a href="%%subscription_center_url%%" alias="Manage Subscriptions" >Manage Subscriptions</a> | <a href="%%profile_center_url%%" alias="Update Profile" >Unsubscribe</a>
                    © Copyright 2002 - 2016  <a href="http://www.bluebeam.com/fr/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank" >Bluebeam, Inc</a>.  All Rights Reserved.</p>
                    <a href="http://www.bluebeam.com/fr/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" ><img src="https://downloads.bluebeam.com/images/2016/universal-assets/bluebeam-b-logo-email-footer.png" alt="Bluebeam Software" ></a>

                    <?php elseif($page->language() == 'ch'): ?>
                    <p>Kontakt: <a href="mailto:sales@bluebeam.com" >Vertrieb</a> | <a href="mailto:support@bluebeam.com" >Support</a> | <a href="http://www.bluebeam.com/ch-de/contact/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" >Hilfe</a></p>
                    <p>Diese E-Mail wurde versendet von: %%Member_Busname%% %%Member_Addr%%,<br>%%Member_City%%, %%Member_State%% %%Member_PostalCode%%, USA. Wir respektieren Ihr Recht auf Datenschutz&nbsp;&ndash; <a href="http://bluebeam.com/us/company/privacy-policy.asp" >sehen Sie sich unsere Richtlinie an</a></p>
                    <p><a href="%%ftaf_url%%" >An einen Freund weiterleiten</a> | <a href="%%subscription_center_url%%" alias="Manage Subscriptions" >Abonnements verwalten</a> | <a href="%%profile_center_url%%" alias="Update Profile" >K&uuml;ndigen</a>  © Copyright 2002 - 2016  <a href="http://www.bluebeam.com/ch-de/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank" >Bluebeam, Inc</a>. Alle Rechte vorbehalten.</p><a href="http://www.bluebeam.com/ch-de/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" ><img src="https://downloads.bluebeam.com/images/2016/universal-assets/bluebeam-b-logo-email-footer.png" alt="Bluebeam Software" ></a>

                    <?php elseif($page->language() == 'it'): ?>
                    <p>Contact Us: <a href="mailto:sales@bluebeam.com" >Sales</a> | <a href="mailto:support@bluebeam.com" >Support</a> | <a href="http://www.bluebeam.com/it/contact/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" >Help</a></p>
                    <p>This email is sent by: %%Member_Busname%% %%Member_Addr%%,<br>%%Member_City%%, %%Member_State%% %%Member_PostalCode%%, USA
                    We respect your right to privacy - <a href="http://bluebeam.com/us/company/privacy-policy.asp" >view our policy</a></p>
                    <p><a href="%%ftaf_url%%" >Forward to a Friend</a> | <a href="%%subscription_center_url%%" alias="Manage Subscriptions" >Manage Subscriptions</a> | <a href="%%profile_center_url%%" alias="Update Profile" >Unsubscribe</a>
                    © Copyright 2002 - 2016  <a href="http://www.bluebeam.com/it/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank" >Bluebeam, Inc</a>.  All Rights Reserved.</p>
                    <a href="http://www.bluebeam.com/it/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" ><img src="https://downloads.bluebeam.com/images/2016/universal-assets/bluebeam-b-logo-email-footer.png" alt="Bluebeam Software" ></a>
                    <?php elseif($page->language() == 'nl'): ?>
                    <p>Contact Us: <a href="mailto:sales@bluebeam.com" >Sales</a> | <a href="mailto:support@bluebeam.com" >Support</a> | <a href="http://www.bluebeam.com/nl/contact/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" >Help</a></p>
                    <p>This email is sent by: %%Member_Busname%% %%Member_Addr%%,<br>%%Member_City%%, %%Member_State%% %%Member_PostalCode%%, USA
                    We respect your right to privacy - <a href="http://bluebeam.com/us/company/privacy-policy.asp" >view our policy</a></p>
                    <p><a href="%%ftaf_url%%" >Forward to a Friend</a> | <a href="%%subscription_center_url%%" alias="Manage Subscriptions" >Manage Subscriptions</a> | <a href="%%profile_center_url%%" alias="Update Profile" >Unsubscribe</a>
                    © Copyright 2002 - 2016  <a href="http://www.bluebeam.com/nl/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank" >Bluebeam, Inc</a>.  All Rights Reserved.</p>
                    <a href="http://www.bluebeam.com/nl/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" ><img src="https://downloads.bluebeam.com/images/2016/universal-assets/bluebeam-b-logo-email-footer.png" alt="Bluebeam Software" ></a>

                    <?php elseif($page->language() == 'no'): ?>
                    <p>Kontakt oss: <a href="mailto:sales.no@bluebeam.com" >Salg</a> | <a href="mailto:support.no@bluebeam.com" >St&oslash;tte</a> | <a href="http://www.bluebeam.com/no/contact/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" >Hjelp</a></p>
                    ...
                    <p><a href="%%ftaf_url%%" >Videresend til en venn</a> | <a href="%%subscription_center_url%%" alias="Manage Subscriptions" >Administrer abonnementer</a> | <a href="%%profile_center_url%%" alias="Update Profile" >Opphev abonnement</a> © Copyright 2002&ndash;2016 <a href="http://www.bluebeam.com/no/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank" >Bluebeam, Inc</a>. Med enerett.</p><a href="http://www.bluebeam.com/no/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" ><img src="https://downloads.bluebeam.com/images/2016/universal-assets/bluebeam-b-logo-email-footer.png" alt="Bluebeam-programvare" ></a>

                    <?php elseif($page->language() == 'se'): ?>
                    <p>Kontakta oss: <a href="mailto:sales.se@bluebeam.com" >F&ouml;rs&auml;ljning</a> | <a href="mailto:support.se@bluebeam.com" >Support</a> | <a href="http://www.bluebeam.com/se/contact/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" >Hj&auml;lp</a></p>
                    ...
                    <p><a href="%%ftaf_url%%" >Vidarebefordra till en v&auml;n</a> | <a href="%%subscription_center_url%%" alias="Manage Subscriptions" >Hantera prenumerationer</a> | <a href="%%profile_center_url%%" alias="Update Profile" >Avanm&auml;l</a> © Copyright 2002 - 2016  <a href="http://www.bluebeam.com/se/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank" >Bluebeam, Inc</a>. Alla r&auml;ttigheter f&ouml;rbeh&aring;lles.</p><a href="http://www.bluebeam.com/se/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" ><img src="https://downloads.bluebeam.com/images/2016/universal-assets/bluebeam-b-logo-email-footer.png" alt="Bluebeam Software" ></a>

                    <?php elseif($page->language() == 'uk'): ?>
                    <p>Contact Us: <a href="mailto:sales.uk@bluebeam.com" >Sales</a> | <a href="mailto:support@bluebeam.com" >Support</a> | <a href="http://www.bluebeam.com/uk/contact/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" >Help</a></p>
                    <p>This email is sent by: %%Member_Busname%% %%Member_Addr%%,<br>%%Member_City%%, %%Member_State%% %%Member_PostalCode%%, USA
                    We respect your right to privacy - <a href="http://bluebeam.com/us/company/privacy-policy.asp" >view our policy</a></p>
                    <p><a href="%%ftaf_url%%" >Forward to a Friend</a> | <a href="%%subscription_center_url%%" alias="Manage Subscriptions" >Manage Subscriptions</a> | <a href="%%profile_center_url%%" alias="Update Profile" >Unsubscribe</a>
                    © Copyright 2002 - 2016  <a href="http://www.bluebeam.com/uk/?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank" >Bluebeam, Inc</a>.  All Rights Reserved.</p>
                    ...
                    <p>© Copyright 2002 - 2016  <a href="http://www.bluebeam.com/" target="_blank">Bluebeam, Inc</a>.  All Rights Reserved.</p>
