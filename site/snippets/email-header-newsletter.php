                    ...
                    <table class="eight columns">
                      <tr>
                        <td class="left-text-pad">
                          <a href="<?php echo $page->parent()->logoUrl() ?>?src=<?php ecco(!$page->tracking()->isEmpty(), $page->tracking()) ?>" target="_blank"><img src="<?php echo $page->parent()->logo() ?>" alt="<?php echo $page->parent()->logoAlt() ?>"></a>
                        </td>
